...
var server = http.createServer(function (req, res) {
    if (req.url == '/') {
        ...
        res.write('<html><body><p>This is the Default Page of the Server and its working fine. If You have not specified anything or a Address, this page should be visible. This is the update on 28-Sep-2023 and it is very important.</p></body></html>');
        res.end();
